...
// Входа контроллера
#define inductive_sensor1 A3          //Вход индуктивного датчика №1  (60)
#define inductive_sensor2 A3          //Вход индуктивного датчика №2  (61)
#define inductive_sensor3 A3          //Вход индуктивного датчика №3  (62)

// Выход на АСУ ТП
#define out_asu_tp1 12               //Выход на АСУ ТП №1
#define out_asu_tp2 12                //Выход на АСУ ТП №2
#define out_asu_tp3 12                //Выход на АСУ ТП №3
#define out_asu_tp4 12                //Выход на АСУ ТП №4
...
#define power_200  A0                // Контроль источника питания 200в
#define power_3V3  A1               // Контроль источника питания +3.3в
#define power_5V0  A2               // Контроль источника питания +5.0в
...
#define TFT_reset 9                 // Назначение pin сброса TFT дисплея.


#define ROD_POSITION1_PIN1 12          // Вход для чтения позиции штанги №1, вверху
#define ROD_POSITION1_PIN2 12          // Вход для чтения позиции штанги №1, внизу

#define ROD_POSITION2_PIN1 12          // Вход для чтения позиции штанги №2, вверху
#define ROD_POSITION2_PIN2 12          // Вход для чтения позиции штанги №2, внизу

#define ROD_POSITION3_PIN1 12          // Вход для чтения позиции штанги №3, вверху
