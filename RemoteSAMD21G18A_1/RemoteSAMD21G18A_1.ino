/*
Пуль управления исполнительными устройствами через канал радиосвязи на модуле XBee868

Версия программы RemoteSAMD21G18A_1
Начало программирования 21.11.2017г.

Микроконтроллер SAMD21G18A

Разработчик модуля Мосейчук А.В.
Email: pronavto@ntmp.ru
г.Москва, Зеленоград
*/
...
TFT9341 myGLCD;                                         //   Дисплей 2.4" 

//!!Внимание!  Уточнить?  Изменены настройки UTouchCD.h
...
//  drawGlavMenu();
  ...
  { 
    ...
    if (oldsec != dt.second)
    {
		...
		myGLCD.print(DS3231_clock.dateFormat("d-m-Y", dt), 6, 303);
		myGLCD.setFont(BigFont);
...
void setup()
{
	...
	//myGLCD.setFont(SmallFont);
	myGLCD.print("LOAD SYSTEM", 30, 120);       // ЗАГРУЗКА
	//myGLCD.setFont(SmallFont);
	//myGLCD.setFont(BigFont);
