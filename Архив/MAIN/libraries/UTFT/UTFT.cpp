...
{ 
	word	dsx[] = {239, 239, 239, 239, 239, 239, 175, 175, 239, 127, 127, 239, 271, 479, 239, 239, 239, 239, 239, 239, 479, 319, 239, 175, 127, 239, 239, 319, 319, 799, 127, 239,175,127,239,239,239,175,175,175};
	word	dsy[] = {319, 399, 319, 319, 319, 319, 219, 219, 399, 159, 127, 319, 479, 799, 319, 319, 319, 319, 319, 319, 799, 479, 319, 219, 159, 319, 319, 479, 479, 479, 159, 399, 219,127,319,399,319,219,219,219};
	byte	dtm[] = {16, 16, 16, 8, 8, 16, 8, SERIAL_4PIN, 16, SERIAL_5PIN, SERIAL_5PIN, 16, 16, 16, 8, 16, LATCHED_16, 8, 16, 8, 16, 16, 16, 8, SERIAL_5PIN, SERIAL_5PIN, SERIAL_4PIN, 16, 16, 16, SERIAL_5PIN, 8,8,8,8,8,8,8,8,8};
...
{   
	...
	if ((display_model == LGDP4524)||(display_model == S6D1121_8))
	{
		cbi(P_RS, B_RS);
		LCD_Writ_Bus16(0x00,VL,display_transfer_mode);
        sbi(P_RS, B_RS);
	}
	
	else if (display_transfer_mode!=1)
	{
		cbi(P_RS, B_RS);
...
#endif
#ifndef DISABLE_ILI9220
	#include "tft_drivers/ili9220/initlcd.h"
#endif
#ifndef DISABLE_R61526
	#include "tft_drivers/r61526/initlcd.h"
#endif
#ifndef DISABLE_HX8352B
	#include "tft_drivers/hx8352b/initlcd.h"
#endif
#ifndef DISABLE_R61580
	#include "tft_drivers/r61580/initlcd.h"
#endif
#ifndef DISABLE_RM68130
	#include "tft_drivers/rm68130/initlcd.h"
#endif
#ifndef DISABLE_ILI9225
	#include "tft_drivers/ili9225/initlcd.h"
#endif
#ifndef DISABLE_LGDP4525
	#include "tft_drivers/lgdp4525/initlcd.h"
#endif
	}
...
#endif
#ifndef DISABLE_ILI9220
	#include "tft_drivers/ili9220/setxy.h"
#endif
#ifndef DISABLE_R61526
	#include "tft_drivers/r61526/setxy.h"
#endif
#ifndef DISABLE_HX8352B
	#include "tft_drivers/hx8352b/setxy.h"
#endif
#ifndef DISABLE_R61580
	#include "tft_drivers/r61580/setxy.h"
#endif
#ifndef DISABLE_RM68130
	#include "tft_drivers/rm68130/setxy.h"
#endif
#ifndef DISABLE_ILI9225
	#include "tft_drivers/ili9225/setxy.h"
#endif
#ifndef DISABLE_LGDP4525
	#include "tft_drivers/lgdp4525/setxy.h"
#endif
	}
}
...
// Переделать
//void UTFT::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t c)
//{
//  setColor(c);
...
void UTFT::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t c)
{
  setColor(c);
...
void UTFT::fillCircle(int x, int y, int radius, uint16_t c)
{
  setColor(c);
